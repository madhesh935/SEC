...
async def create_pairing_code(
    ...
    return PairingCodeCreateResponse(pairing_code=result["pairing_code"], expires_at=result["expires_at"])
...
async def verify_pairing(payload: PairingVerifyRequest) -> PairingVerifyResponse:
...
async def verify_pairing_pin(payload: PairingVerifyPinRequest) -> PairingVerifyResponse:
    pairing_verify_limiter.check(payload.deviceId)
