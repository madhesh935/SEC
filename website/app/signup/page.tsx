...
import { Heart, Eye, EyeOff, AlertCircle, RefreshCw, ShieldCheck } from "lucide-react";
...
export default function SignupPage() {
  ...
  const { user, isAuthenticated, signup, loginWithGoogle, isLoading, error, clearError } = useAuth();
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-card">
          <div className="mb-6">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Set up access to companion signals, memory management, and caregiver alerts.
            </p>
          </div>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-semibold">Unable to create your account.</p>
