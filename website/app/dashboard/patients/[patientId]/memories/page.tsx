...
import { Memory, MemoryCategory, SensitivityLevel } from "@/types";
...
export default function PatientMemoriesPage() {
  ...
  const [selectedSensitivity, setSelectedSensitivity] = React.useState<string>("ALL");
  ...
  const handleModalSubmit = async (formData: Parameters<typeof createMutation.mutateAsync>[0]) => {
    if (editingMemory) {
